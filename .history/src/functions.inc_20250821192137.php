...
function cleanSearchQuery($query, $minLength = 3) {
    ...
    $words = array_filter(explode(' ', trim($query)), function($word) use ($minLength) {
...
/**
 * Escaped einen Wert sicher für SQL-Abfragen (für PDO).
 *
 ...
 */
function mapIngredientsToReadable(array $ingredients, $schemaFile = 'brot_schema_v1.json') {
    $readable = [];
